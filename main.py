...
# you're not supposed to see this, built for my friends
async def gaminggr(update: Update, context: CallbackContext):
    replys = ["Asa", "Syn", "Zarvan", "Eman", "Rohan", "Dimitri",
              "Fern", "Xenos"]
    answer = random.choice(replys)
    await update.message.reply_text(answer)
...
def handle_response(text: str) -> str:
    ...
    # this is a stupid thing, you can get rid of it if you want
    if 'guess who' in text:
        return 'your mom'
    ...
    # again something for my friends
    ...
    if text.lower()[0:10] == 'how gay is':
        ...
        if text.lower()[11:17] == 'zarvan':
            return 'Zarvan is the straightest man alive'
        elif text.lower()[11:14] == 'asa':
            return 'depends on how cute the person is'
        else:
            name = text[11:]
    ...
    if text.lower()[0:13] == 'how stupid is':
        ...
        if text.lower()[14:20] == 'zarvan':
            return 'Zarvan is smart asf, never question it.'
        elif text.lower()[14:17] == 'asa':
            return 'asabop is smart enough xD'
        else:
            name = text[14:]
            adjek = ["not", "just abit", "normally", "abnormally", "extremely", "unbelievably", "unpredictably",
                     "ultra", "overly", "weirdly"]
...
if __name__ == '__main__':
    ...
    app.add_handler(CommandHandler('gaminggr', gaminggr))
